...
- The shippable installers (the `.exe` and winget) fall back to the **classic** registry verb → lands under "Show more options". Installs cleanly for everyone, no Developer Mode needed.
